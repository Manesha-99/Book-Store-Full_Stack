  ...
  return (
    <div className="p-4">
      ...
      {loading ? (
        ...
        <div className="flex flex-col p-4 border-2 rounded border-sky-400-x1 w-fit">
          <div className="my-4">
          ...
          <div className="my-4">
            <span className="mr-4 text-xl text-gray-500">Created Time:</span>
            <span>{new Date(book.createdAt).toString()}</span>
          </div>
          <div className="my-4">
            <span className="mr-4 text-xl text-gray-500">Updated Time:</span>
